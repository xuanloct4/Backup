...
static int forced_nth_key_frames = 0 ;
...
//av_log(NULL, AV_LOG_DEBUG, "%"PRId64" -> encoder\n", ost->sync_opts);
            ...
            if(forced_nth_key_frames) {
                if (ost->forced_kf_index > forced_nth_key_frames ) {
            ...
            else if (ost->forced_kf_index < ost->forced_kf_count &&
...
#include "cmdutils_common_opts.h"
    ...
    { "force_nth_key_frames", OPT_INT | HAS_ARG | OPT_EXPERT | OPT_VIDEO, {(void *)&forced_nth_key_frames}, "force key frames every Nth frame", "number" },
