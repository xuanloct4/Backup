...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-doc --disable-ffmpeg --disable-ffserver --disable-ffplay --disable-ffprobe --disable-debug --disable-shared --enable-static --disable-muxers --disable-demuxers --disable-filters --enable-muxer=mov --enable-muxer=flv --enable-demuxer=mov --enable-demuxer=flv --enable-decoder=h264 --enable-decoder=mov --enable-encoder=mjpeg --enable-decoder=mjpeg --enable-parser=mov --enable-parser=flv --enable-librtmp --enable-cross-compile --arch=arm --target-os=darwin --enable-pic --cc=/usr/bin/gcc --as='./gas-preprocessor/gas-preprocessor.pl /usr/bin/gcc' --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS10.1.sdk --cpu=cortex-a8 --extra-cflags='-arch armv7 -I/Users/fiona/dev/mobile/media/rtmp/' --extra-ldflags='-arch armv7 -L/Users/xuanloctn/Downloads/LivuLib-master/rtmp/ -lcrypto -lssl' --extra-libs=../rtmp/build/Release-iphoneos/librtmp.a
prefix=/usr/local
...
SRC_PATH="/Users/xuanloctn/Downloads/LivuLib-master/ffmpeg"
SRC_PATH_BARE=/Users/xuanloctn/Downloads/LivuLib-master/ffmpeg
BUILD_ROOT="/Users/xuanloctn/Downloads/LivuLib-master/ffmpeg"
CC_IDENT=gcc 4.2.1 (dot 2)
ARCH=arm
CC=/usr/bin/gcc
AS=gas-preprocessor.pl /usr/bin/gcc
LD=/usr/bin/gcc
DEPCC=/usr/bin/gcc
YASM=yasm
YASMDEP=yasm
...
LN_S=ln -sf
STRIP=strip -x
CPPFLAGS= --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS10.1.sdk -D_ISOC99_SOURCE -D_POSIX_C_SOURCE=200112 -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DPIC
CFLAGS= -arch armv7 -I/Users/xuanloctn/Downloads/LivuLib-master/rtmp/ -mcpu=cortex-a8 -std=c99 -fomit-frame-pointer -fPIC -marm -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wundef -Wmissing-prototypes -O3 -fno-math-errno -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes
ASFLAGS= -arch armv7 -I/Users/xuanloctn/Downloads/LivuLib-master/rtmp/ -mcpu=cortex-a8 -fPIC
CC_O=-o $@
LDFLAGS= -arch armv7 -L//Users/xuanloctn/Downloads/LivuLib-master/rtmp/ -lcrypto -lssl --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS10.1.sdk -Wl,-dynamic,-search_paths_first
...
EXTRALIBS=-L/Users/xuanloctn/Downloads/LivuLib-master/rtmp/lib -lrtmp -lz -lm -lz ../rtmp/build/Release-iphoneos/librtmp.a
INSTALL=install
LIBTARGET=
...
libavcodec_VERSION=52.97.2
libavcodec_VERSION_MAJOR=52
libavcore_VERSION=0.14.0
libavcore_VERSION_MAJOR=0
libavdevice_VERSION=52.2.2
libavdevice_VERSION_MAJOR=52
libavformat_VERSION=52.87.1
libavformat_VERSION_MAJOR=52
libavutil_VERSION=50.33.0
libavutil_VERSION_MAJOR=50
libavfilter_VERSION=1.67.0
...
ACODEC_TESTS=ac3 adpcm_ima_qt adpcm_ima_wav adpcm_ms adpcm_swf adpcm_yam alac flac g726 mp2 pcm wmav1 wmav2
...
LAVF_TESTS=bmp flv_fmt gif jpg mov pbmpipe pcx pgm pgmpipe png ppm ppmpipe sgi tga tiff
LAVFI_TESTS=crop crop_scale crop_scale_vflip crop_vflip null pixdesc_le pixfmts_crop_le pixfmts_hflip_le pixfmts_null_le pixfmts_pad_le pixfmts_scale_le pixfmts_vflip_le scale200 scale500 vflip vflip_crop vflip_vflip
